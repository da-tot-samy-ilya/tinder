...
export class TinderUser {
    ...
    constructor(id: string, name: string, age: number = 0, town: string = "", interests: InterestClass[] = [], description: string = "", images: TinderImage[] = [], mainImage: TinderImage = TinderImage.defaultImage) {
        this.id = id
        this.name = name
        this.age = age
        this.town = town
